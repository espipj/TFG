...
@section('contenido')
    ...
    @else
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-content">
                        ...
                        <h4 class="card-color-text">Dirección:
                            <div class="card-color-text-normal">{{$asociacion->direccion}}</div>
                        </h4>
                        <h4 class="card-color-text">Email:
                            <div class="card-color-text-normal"><a
                                        href="mailto:{{$asociacion->email}}">{{$asociacion->email}}</a></div>
                        </h4>
                        <h4 class="card-color-text">Telefono:
                            <div class="card-color-text-normal"><a
                                        href="tel:{{$asociacion->telefono}}">{{$asociacion->telefono}}</a></div>
                        </h4>
                        <br>
            ...
            <div class="col-sm-6">
                <iframe class="card" width="100%" height="27.5%" frameborder="0" style="border:0"
                        src="https://www.google.com/maps/embed/v1/place?q={{$asociacion->direccion}}&key=AIzaSyDbqmt5yJhB68YvNo_gJjiV8GA1kb3PJHk"
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <a href="{{url('registrar/ganaderia',['asociacion'=>$asociacion])}}"
