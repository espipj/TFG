...
class GenesController extends Controller
{
    ...
    {
        $this->validate($request, [
            'tgla227_1' => ['required','numeric'],
            'tgla227_2' => ['required','numeric'],
            'tgla53_1' => ['required','numeric'],
            'tgla53_2' => ['required','numeric'],
            'eth10_1' => ['required','numeric'],
            'eth10_2' => ['required','numeric'],
            'sps115_1' => ['required','numeric'],
            'sps115_2' => ['required','numeric'],
            'tgla126_1' => ['required','numeric'],
            'tgla126_2' => ['required','numeric'],
            'tgla122_1' => ['required','numeric'],
            'tgla122_2' => ['required','numeric'],
            'inra023_1' => ['required','numeric'],
            'inra023_2' => ['required','numeric'],
            'bm1818_1' => ['required','numeric'],
            'bm1818_2' => ['required','numeric'],
            'eth3_1' => ['required','numeric'],
            'eth3_2' => ['required','numeric'],
            'eth225_1' => ['required','numeric'],
            'eth225_2' => ['required','numeric'],
            'bm1824_1' => ['required','numeric'],
            'bm1824_2' => ['required','numeric'],
            'bm2113_1' => ['required','numeric'],
            'bm2113_2' => ['required','numeric'],
            'ganado_id' => ['required','numeric'],
        ]);
